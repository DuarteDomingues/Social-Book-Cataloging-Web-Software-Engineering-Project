...
class Colecao():
    ...
    def set_lista_ler(self,lista_ler):
        self.__lista_ler = lista_ler

    def set_lista_ja_leu(self,lista_ja_leu):
        self.__lista_ja_leu = lista_ja_leu

    def set_lista_a_ler(self, lista_a_ler):
        self.__lista_a_ler = lista_a_ler
    ...
    def adicionar_lista_a_ler(self, livro_colecao):
        if livro_colecao not in self.__lista_a_ler:
            self.__lista_a_ler.append(livro_colecao)
